...
```{r}
model = lmer(learned_epoch ~ mode_0_S + mode_1_S + early_proj_AND + early_mode_1_proj_OR + early_d1_abs_proj + analogous  + (1 | run), learned_and_features_d)
BIC(model)
summary(model)
```
...
```
```{r}
vars_of_interest = c("d1_MSE_z", "S_z", "proj_AND_z")
